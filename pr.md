...
🎯 **What:**
The `public.handle_new_user()` function in `supabase/schema.sql` hardcoded specific email addresses and their roles (`'hatimhtm2003@gmail.com'` for 'king', `'queen@example.com'` for 'queen'). This was an insecure design as it hardcoded configuration/access controls directly within the database schema.
