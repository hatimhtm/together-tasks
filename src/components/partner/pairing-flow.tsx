...
export function PartnerPairingFlow({ profile }: { profile: Profile }) {
  ...
  const [step, setStep] = useState<
    "initial" | "generate" | "enter" | "confirm"
  >("initial");
  ...
  const handleGenerateCode = async () => {
    ...
    try {
      ...
      const codeArray = new Array(6);
      for (let i = 0; i < 6; i++) {
        codeArray[i] = chars.charAt(randomBytes[i] % chars.length);
      }
  ...
  return (
    <div className="max-w-md mx-auto space-y-6">
        ...
        <GlassCard className="p-8">
          <div className="text-center space-y-6">
            ...
            <div>
              ...
              <p className="text-white/70">Choose how you want to connect</p>
            </div>
      ...
      {step === "generate" && linkCode && (
        <GlassCard className="p-8">
          <div className="text-center space-y-6">
            <h3 className="text-xl font-semibold text-white">Your Link Code</h3>
            ...
            <div className="space-y-2">
              ...
              <p className="text-white/50 text-xs">Code expires in 24 hours</p>
            </div>
          ...
          <div className="space-y-6 text-center">
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">
                Do you accept this invitation to share your tasks, goals, and
                journey together?
              </p>
            </div>
